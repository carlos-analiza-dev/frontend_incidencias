import { CrearAccionAccidente } from "@/api/acciones/crear-accion-accidente";
...
const FormAccionesAccidentes = ({ user, accidente_id }: Props) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const data = {
        ...
        accidente_accion_id: accidente_id,
        usuario_accion_id: user.id,
      };

      await CrearAccionAccidente(data);
...
export default FormAccionesAccidentes;
