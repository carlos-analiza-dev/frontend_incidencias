import { CreateVerificacionAccionAccidente } from "@/api/acciones/crear-verificacion-acciones";
...
const FormVerificacionAccionesAccidentes = ({ user, accidente_id }: Props) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!accidente_id) {
      toast({
        title: "Error",
        description: "No se encontro el accidente para esta accion",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      await CreateVerificacionAccionAccidente(data);
...
export default FormVerificacionAccionesAccidentes;
