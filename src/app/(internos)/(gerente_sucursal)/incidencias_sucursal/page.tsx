"use client";
import { GetIncidenciasBySucursal } from "@/api/incidencias/obtener-incidencias";
...
const IncidentesSucursalesPage = () => {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ["incidencias-sucursal", limit, offset],
    queryFn: () => GetIncidenciasBySucursal(limit, offset, sucursalId ?? ""),
  });
...
export default IncidentesSucursalesPage;
